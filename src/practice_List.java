...
//
////        for문으로 배열에 넣을시 오토박싱으로 변환해줌 // 배열이 int인 경우 List로 변경 시 제일 편한 방법
...
//        myList2.add(50);
//
////        addAll(Collections객체) : 특정 리스트의 요소를 모두 add
...
//        }
////        remove : 요소 삭제
////        remove는 value삭제, index를 통한 삭제 두가지 방법
////
...
//        System.out.println(myList);
//
////        set(int index, E element) : index자리에 값 변경, E element는 요소 String 일수도 있고 int일수도 있고
////        마지막 자리값 : 100으로 세팅 후 출력
...
//        Collections.sort(myList); //기본 오름차순 정렬
//        System.out.println(myList);
