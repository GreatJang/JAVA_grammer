...
//import java.util.*;
//public class AuthorPostService10 {
//    public static void main(String[] args) {
//        List<Author> authors = new ArrayList<>();
//        List<Post> posts = new ArrayList<>();
//        while(true){
//            System.out.println("1번 : 회원가입, 2번 : 게시글작성, 3번 : 회원목록 조회, 4번 : 회원상세조회, 5번 : 게시글 상세조회");
...
////                    게시글 상세조회
//                case 5:
//                    System.out.println("post id를 입력해주새요");
